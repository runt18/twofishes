...
try:
  ...
  print 'Downloading Flickr Shapes File to {0!s}'.format(flickr_shapes_file_name)
...
for file_info in old_tar:
  print 'Processing {0!s}'.format(file_info.name)
  ...
  print 'Writing updated {0!s}'.format(file_info.name)
